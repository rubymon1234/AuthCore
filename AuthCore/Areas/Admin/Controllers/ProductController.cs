    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            List<ProductView> productView = await(from p in _dbContext.Product
                            ...
                            join cat in _dbContext.ProductCatagory on p.CatagoryId equals cat.Id
        ...
        {
            var categories = _dbContext.ProductCatagory.ToList();
        ...
        public IActionResult Create(Product product)
        {
            try
            {
                ...
                string newFileName = Guid.NewGuid().ToString();
                    ...
                    productImg.url = @"images\productImage\" + newFileName + extension;
            }
